...
namespace TrustCarCRM.Controllers
{
    public class UtilisateursController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("UtilisateurId,Nom_Utilisateur,Prenom_Utilisateur,Email_Utilisateur,Telephone_Utilisateur,Role,Password_Utilisateur")] Utilisateur utilisateur)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("UtilisateurId,Nom_Utilisateur,Prenom_Utilisateur,Email_Utilisateur,Telephone_Utilisateur,Role,Password_Utilisateur")] Utilisateur utilisateur)
        {
